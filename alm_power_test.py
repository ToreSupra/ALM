...
class Context:
    ...
    skyline: SkylineDevice = field(default_factory=SkylineDevice)
    ...
    P3_max_current:   float = 0.0     # absolute angle of power maximum
    P3_min_current:   float = 0.0     # absolute angle of power minimum
